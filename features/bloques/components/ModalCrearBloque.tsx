...
import { View, Text, TextInput, TouchableOpacity, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard, ScrollView, StyleSheet, useWindowDimensions } from 'react-native';
...
/**
 * ModalCrearBloque: Ahora con el sistema estándar de difuminado (Blur).
 */
